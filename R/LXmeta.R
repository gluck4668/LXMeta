...
# list all the packages that have been installed
  ...
  R_packs_install <- function(){
    ...
    metr_pkgs <- c("devtools", "httr", "openxlsx", "magrittr", "dplyr",
                 ...
                 "roxygen2", "XML", "RCurl", "curl", "stringr",
                 "plyr", "momr","patchwork","ggpubr","scales","ggplotify","pak")
  ...
  if("tidyverse" %in% all_packages[,1] ==FALSE)
    pak::pak("tidyverse/tidyverse") else
      print("tidyverse has been installed")
